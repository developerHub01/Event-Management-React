...
const Service = ({ id, title, description, price, serviceImg }) => {
  return (
    <figure className="w-full rounded-xl h-full overflow-hidden flex flex-col shadow-2xl hover:scale-95 transition-all ease-in-out duration-75 cursor-pointer">
